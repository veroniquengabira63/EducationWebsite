...
.collegedetailsPage .card-header {
    margin: 10px 0;
    background: #fff;
}

.collegedetailsPage .card.mb-0 {
    background: transparent;
    border: none;
}
    ...
    <div class="container">
        <ul class="links collegeDetailsLinks">
           <li ><a href="<?php base_url() ?>/single/<?php echo $college->id.'/'.$link  ?>">Overview</a></li>
            ...
            <li class="active" ><a href="<?php base_url() ?>/admission/<?php echo $college->id  ?>">Admissions</a></li>
    ...
    <div class="container admission">
        <div class="row">
           <div class="col-md-12 bodyContent">
             <h2> Admission Eligibility by <?php echo $college->college_name ?></h2>
            <div class="block box">
                <div id="accordion" class="accordion">
                    <div class="card mb-0">
                        ...
                        <div class="card-header collapsed" data-toggle="collapse" href="#<?php echo $details->id ?>">
                            <a class="card-title">
                                <?php echo getCourse($details->course_name); ?>
                            </a>
                        </div>
                        <div id="<?php echo $details->id ?>" class="card-body collapse" data-parent="#accordion" >
                            <p>
