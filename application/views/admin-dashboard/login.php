...
<head>
  ...
  <title>College Admin  | Log in</title>
...
<?php 
                      if ($this->session->flashdata('invalid')) {
                       ...
                       ?>
                    <div class="alert alert-danger">Invalid UserID and Password</div>
                <?php } ?>
      <form action="<?php echo base_url() ?>/admin/validation" method="post">
