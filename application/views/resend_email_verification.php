    ...
    <div class="login-right loginform font-set left">
        <div class="main-form login-form data-wrap">
            <div class="login-div">               
                ...
                <form method="post" id="resend_form" action="<?php echo base_url() ?>/home/resendEmail">
 
                    <input placeholder="Enter your email" class="form-control validate" type="email" id="user_email" name="email" required="">
                 
					<button class="btn btnlogin" type="submit">Resend</button>
					</form>
            </div>
...
<script type="text/javascript">
    ...
    rules: 
    {
        ...
        email: 
        {
            ...
            remote:
            {
                url: '<?php echo base_url() ?>home/email_exists',
                type: "post",
                dataType: "json",
                data:
                {
