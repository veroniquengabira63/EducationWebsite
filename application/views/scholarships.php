    ...
    <div class="container">
        <ul class="links collegeDetailsLinks">
           <li ><a href="<?php base_url() ?>/single/<?php echo $college->id.'/'.$link  ?>">Overview</a></li>
            ...
            <li class="active"><a href="<?php base_url() ?>/scholarships/<?php echo $college->id  ?>">Scholarships</a></li>
    ...
    <div class="container admission">
        <div class="row">
           <div class="col-md-12 bodyContent">
             <h2> Scholarships by <?php echo $college->college_name ?></h2>
            <div class="block box" style="overflow-x: auto; display: block;">
                <p >
