...
.newsBlock ul.list li:first-child {
    border: 0;
    padding-top: 0;
}
.newsBlock ul.list .image {
    padding-left: 0;
    padding-right: 8px;
}
.newsBlock ul.list .info {
    padding-left: 8px;
    padding-right: 0;
}
.newsBlock .title {
...
.newsBlock ul.list li .newsInfo a {
    display: inline-block;
}
.newsInfo .date, .newsInfo .readTime {
    padding-left: 20px;
    margin-left: 15px;
    position: relative;
}
...
<div class="collegeTabs" data-gssticky="1" style="top: 0px; position: sticky;">
    <div class="container">
        <ul class="links collegeDetailsLinks">
           <li ><a href="<?php base_url() ?>/single/<?php echo $college->id.'/'.$link  ?>">Overview</a></li>
            ...
            <li class="active"><a href="<?php base_url() ?>/news/<?php echo $college->id  ?>">News</a></li>
...
<!--=============================================== tabs==================================================== -->
<!--=============================================== Main Content==================================================== -->
<div class="collegedetailsPage">
    <div class="container admission">
        <div class="row">
           <div class="col-md-12 bodyContent">
            <div class="block newsBlock" data-gtm-vis-recent-on-screen-6581841_160="1898" data-gtm-vis-first-on-screen-6581841_160="1898" data-gtm-vis-total-visible-time-6581841_160="100" data-gtm-vis-has-fired-6581841_160="1">
                <div class="box">
                    <h2><?php echo $college->college_name ?> News</h2>
                    <ul class="list">
                        ...
                        <li class="row">
                            <div class="col-md-3 image">
                                <a href="#">
                                    <img src="<?php echo base_url() ?>/assets/images/post_images/<?php echo $post->featured_image ?>" alt="" class="dtn-img initial loading" ></a>
                            </div>
                            <div class="col-md-9 info">
                                ...
                                <div class="newsInfo">
                                 <span class="date"><i class="fa fa-calendar"></i> Jul 01,2020</span>
                                </div>
                                <?php $this->load->helper('text'); ?>
                                <p><?php echo word_limiter(strip_tags($post->description),40); ?></p>
                            </div>
                        </li>
                       <?php endforeach ?>
                    </ul>
